...
int main(int argc, char *argv[])
{
  ...
  CUDAERR(cudaMallocManaged((void**)&x, n*sizeof(double), cudaMemAttachGlobal));
  CUDAERR(cudaMallocManaged((void**)&y, n*sizeof(double), cudaMemAttachGlobal));
  CUDAERR(cudaMallocManaged((void**)&A, n*n*sizeof(double), cudaMemAttachGlobal));
  /* END NEW */
