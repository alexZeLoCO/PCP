...
mandelAlumnx.restype  = None
mandelAlumnx.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_int, ctypes.c_int, ctypes.c_int, ndpointer(ctypes.c_double, flags="C_CONTIGUOUS")]

# Preparando para el uso de "double promedio(int, int, double *)"
mediaAlumnx = libAlumnx.promedio

mediaAlumnx.restype  = ctypes.c_double
mediaAlumnx.argtypes = [ctypes.c_int, ctypes.c_int, ndpointer(ctypes.c_double, flags="C_CONTIGUOUS")]

# Preparando para el uso de "void binariza(int, int, double *, double)"
binarizaAlumnx = libAlumnx.binariza

binarizaAlumnx.restype  = None
binarizaAlumnx.argtypes = [ctypes.c_int, ctypes.c_int, ndpointer(ctypes.c_double, flags="C_CONTIGUOUS"), ctypes.c_double]
...
if __name__ == "__main__":
    ...
    fractalAlumnx = np.zeros(yres*xres).astype(np.double) #Esta es para el alumno
    ...
    print('El error es '+ str(LA.norm(fractalAlumnx-fractalProf)))
